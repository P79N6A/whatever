...
public class CustomThreadPoolExecutor {
    ...
    private static final ExecutorService scheduledThreadPool = Executors.newScheduledThreadPool(2);
    ...
    public static void main(String[] args) {
        ...
        ((ScheduledExecutorService) scheduledThreadPool).scheduleWithFixedDelay(() -> {
        }, 0, 2, TimeUnit.SECONDS);
