...
public class CustomThreadPoolExecutor {
     ...
     *
     * */
    private static final mmp.threadpool.ExecutorService threadPoolExecutor =
            new mmp.threadpool.ThreadPoolExecutor(5, 20, 0L, TimeUnit.MILLISECONDS,
                    new LinkedBlockingQueue<>(1024), new mmp.threadpool.ThreadPoolExecutor.AbortPolicy());
