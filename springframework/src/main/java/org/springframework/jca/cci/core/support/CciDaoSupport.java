 ...
 *
 * <p>Requires a {@link ConnectionFactory} to be set,
...
public abstract class CciDaoSupport extends DaoSupport {
     ...
     * @see org.springframework.jca.cci.core.CciTemplate#getDerivedTemplate(ConnectionSpec)
     */
     ...
     * @see org.springframework.jca.cci.connection.ConnectionFactoryUtils#getConnection(ConnectionFactory)
     */
