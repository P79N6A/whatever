 ...
 * @see #createInputRecord(RecordFactory, Object)
 * @see #extractOutputData(Record)
 * @since 1.2
 */
public abstract class MappingRecordOperation extends EisOperation {
     ...
     *
     * @see javax.resource.cci.Interaction#execute(InteractionSpec, Record)
     * @see javax.resource.cci.Interaction#execute(InteractionSpec, Record, Record)
