 ...
 *
 * <p>Code using this class can pass in and receive {@link Record}
...
public class CciTemplate implements CciOperations {
     ...
     */
    @Nullable
    protected <T> T doExecute(final InteractionSpec spec, final Record inputRecord, @Nullable final Record outputRecord, @Nullable final RecordExtractor<T> outputExtractor) throws DataAccessException {
     ...
     * @see #getRecordFactory(ConnectionFactory)
     ...
     * @throws DataAccessException if creation of the Record failed
     * @see #getRecordFactory(ConnectionFactory)
     * @see RecordCreator#createRecord(RecordFactory)
     */
