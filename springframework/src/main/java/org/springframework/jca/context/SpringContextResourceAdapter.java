...
/**
 * JCA 1.7 {@link ResourceAdapter} implementation
 ...
 *
 * <p>The JCA {@link BootstrapContext} may also be
...
public class SpringContextResourceAdapter implements ResourceAdapter {
    ...
    public boolean equals(Object other) {
        return (this == other || (other instanceof SpringContextResourceAdapter && ObjectUtils.nullSafeEquals(getContextConfigLocation(), ((SpringContextResourceAdapter) other).getContextConfigLocation())));
    }
