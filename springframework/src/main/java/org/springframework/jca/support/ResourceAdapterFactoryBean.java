 ...
 * the specified JCA 1.7 {@link ResourceAdapter},
 * starting it with a local {@link BootstrapContext}
 ...
 * @see #setWorkManager
 * @see ResourceAdapter#start(BootstrapContext)
 * @see ResourceAdapter#stop()
 * @since 2.0.3
 */
