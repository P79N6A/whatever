...
public class Indexer extends SpelNodeImpl {
    ...
    public boolean isCompilable() {
        if (this.indexedType == IndexedType.ARRAY) {
            ...
            return (this.cachedReadAccessor != null && this.cachedReadAccessor instanceof ReflectivePropertyAccessor.OptimalPropertyAccessor && getChild(0) instanceof StringLiteral);
        }
        return false;
    }
    ...
    private class PropertyIndexingValueRef implements ValueRef {
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            try {
                ...
                throw new SpelEvaluationException(getStartPosition(), ex, SpelMessage.EXCEPTION_DURING_PROPERTY_WRITE, this.name, ex.getMessage());
            }
        }
    ...
    private class CollectionIndexingValueRef implements ValueRef {
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            if (this.collection instanceof List) {
                ...
                throw new SpelEvaluationException(getStartPosition(), SpelMessage.INDEXING_NOT_SUPPORTED_FOR_TYPE, this.collectionEntryDescriptor.toString());
            }
        }
    ...
    private class StringIndexingLValue implements ValueRef {
        ...
        @Override
        public void setValue(@Nullable Object newValue) {
            throw new SpelEvaluationException(getStartPosition(), SpelMessage.INDEXING_NOT_SUPPORTED_FOR_TYPE, this.typeDescriptor.toString());
        }
