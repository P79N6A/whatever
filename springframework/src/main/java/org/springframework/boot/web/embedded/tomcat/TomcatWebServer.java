            ...
            try {
                ...
                context.addLifecycleListener((event) -> {
                    if (context.equals(event.getSource()) && Lifecycle.START_EVENT.equals(event.getType())) {
                        ...
                        // 从容器中把Connector删掉，后面start只会启动Connector外的部分如Server，Service，Engine
                ...
                // 与Jetty不同，Tomcat所有的线程都是守护线程，所以创建一个阻塞的非守护线程避免立即shutdown
                // 调用TomcatWebServer.this.tomcat.getServer().await()阻塞线程
