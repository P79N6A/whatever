...
public final class ClassGenerator {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(ClassGenerator.class);
    ...
    private void writeClassToFile(CtClass ctClass) {
        /*
         * 嗯，测试
         */
        logger.debug("========== ↓ \n");
        ...
        // windows文件名不区分大小写
        try (FileOutputStream fos = new FileOutputStream(new File(ctClass.getName() + "_" + System.currentTimeMillis() + ".class"))) {
