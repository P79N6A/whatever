...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
     ...
     * 构建参数映射集合
     * 构建注册中心链接列表
     * 遍历链接列表，并根据条件决定是否将其添加到registryList
     *
        ...
        if (CollectionUtils.isNotEmpty(registries)) {
            for (RegistryConfig config : registries) {
                ...
                if (!RegistryConfig.NO_AVAILABLE.equalsIgnoreCase(address)) {
                    ...
                    // 添加ApplicationConfig中的字段信息到map
                    appendParameters(map, application);
                    // 添加RegistryConfig字段信息到map
                    ...
                    // [zookeeper://127.0.0.1:2181/org.apache.dubbo.registry.RegistryService?application=dubbo-demo-api-consumer&dubbo=2.0.2&pid=2000&timestamp=1562835941334]
                    ...
                    for (URL url : urls) {
                        ...
                        // registry://127.0.0.1:2181/org.apache.dubbo.registry.RegistryService?application=dubbo-demo-api-consumer&dubbo=2.0.2&pid=2000&registry=zookeeper&timestamp=1562835941334
