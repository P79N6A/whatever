...
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    public String toString() {
        return "ExpiringMap{" + "delegateMap=" + delegateMap.toString() + ", expireThread=" + expireThread.toString() + '}';
    }
    ...
    public class ExpireThread implements Runnable {
        ...
        @Override
        public String toString() {
            return "ExpireThread{" + ", timeToLiveMillis=" + timeToLiveMillis + ", expirationIntervalMillis=" + expirationIntervalMillis + ", running=" + running + ", expirerThread=" + expirerThread + '}';
        }
