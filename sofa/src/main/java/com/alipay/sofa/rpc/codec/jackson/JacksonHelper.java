...
public class JacksonHelper {
    ...
    private void loadClassToCache(String key, Class clazz, String methodName) {
        ...
        if (parameterTypes == null || parameterTypes.length != 1) {
            throw new SofaRpcRuntimeException("class based jackson: " + clazz.getName() + ", only support one parameter!");
        }
        ...
        if (resClass == void.class) {
            throw new SofaRpcRuntimeException("class based jackson: " + clazz.getName() + ", do not support void return type!");
        }
