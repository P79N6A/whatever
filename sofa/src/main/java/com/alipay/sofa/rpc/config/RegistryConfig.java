...
public class RegistryConfig extends AbstractIdConfig implements Serializable {
    ...
    public String toString() {
        return "RegistryConfig{" + "protocol='" + protocol + '\'' + ", address='" + address + '\'' + ", index='" + index + '\'' + ", register=" + register + ", subscribe=" + subscribe + ", timeout=" + timeout + ", connectTimeout=" + connectTimeout + ", file='" + file + '\'' + ", batch=" + batch + ", batchSize=" + batchSize + ", heartbeatPeriod=" + heartbeatPeriod + ", reconnectPeriod=" + reconnectPeriod + ", parameters=" + parameters + '}';
    }
