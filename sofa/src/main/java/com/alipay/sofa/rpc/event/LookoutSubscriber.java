...
public class LookoutSubscriber extends Subscriber {
    ...
    public void onEvent(Event event) {
        ...
        if (eventClass == ClientEndInvokeEvent.class) {
            ...
            RpcClientLookoutModel rpcClientMetricsModel = createClientMetricsModel(clientEndInvokeEvent.getRequest(), clientEndInvokeEvent.getResponse());
            ...
            RpcServerLookoutModel rpcServerMetricsModel = createServerMetricsModel(serverSendEvent.getRequest(), serverSendEvent.getResponse());
            ...
            rpcMetrics.collectThreadPool(serverStartedEvent.getServerConfig(), serverStartedEvent.getThreadPoolExecutor());
