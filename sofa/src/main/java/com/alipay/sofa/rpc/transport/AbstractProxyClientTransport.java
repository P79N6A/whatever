...
public abstract class AbstractProxyClientTransport extends ClientTransport {
    ...
    public AbstractProxyClientTransport(ClientTransportConfig transportConfig) {
        ...
        // 能telnet通
        open = proxy != null && NetUtils.canTelnet(provider.getHost(), provider.getPort(), transportConfig.getConnectTimeout());
    ...
    public void connect() {
        ProviderInfo provider = transportConfig.getProviderInfo();
        open = NetUtils.canTelnet(provider.getHost(), provider.getPort(), transportConfig.getConnectTimeout());
    }
