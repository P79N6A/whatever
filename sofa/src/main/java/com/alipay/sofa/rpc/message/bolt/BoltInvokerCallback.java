...
public class BoltInvokerCallback extends AbstractInvokeCallback {
     ...
     */
    public BoltInvokerCallback(ConsumerConfig consumerConfig, ProviderInfo providerInfo, SofaResponseCallback listener, SofaRequest request, RpcInternalContext context, ClassLoader classLoader) {
