...
public class ProtobufSerializer extends AbstractSerializer {
        ...
        if (object == null) {
            ...
            if (method == null) {
                try {
                    ...
                    throw buildSerializeError("Cannot found method " + clazz.getName() + ".toByteArray(), please check the generated code.", e);
                }
            }
            try {
            ...
            throw buildSerializeError("Unsupported class:" + object.getClass().getName() + ", only support protobuf message");
        }
    }
                ...
                if (method == null) {
                    try {
                        ...
                        if (!Modifier.isStatic(method.getModifiers())) {
                            throw buildDeserializeError("Cannot found static method " + clazz.getName() + ".parseFrom(byte[]), please check the generated code");
                        }
                        method.setAccessible(true);
                        protobufHelper.parseFromMethodMap.put(clazz, method);
                    } catch (NoSuchMethodException e) {
                        throw buildDeserializeError("Cannot found method " + clazz.getName() + ".parseFrom(byte[]), please check the generated code", e);
                    }
                }
                try {
    ...
    private void decodeSofaRequest(AbstractByteBuf data, SofaRequest sofaRequest, Map<String, String> head) {
        ...
        Class requestClass = protobufHelper.getReqClass(targetService, sofaRequest.getMethodName());
