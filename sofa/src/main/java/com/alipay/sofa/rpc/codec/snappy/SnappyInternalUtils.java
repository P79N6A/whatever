...
final class SnappyInternalUtils {
    ...
    static {
        ...
        if (memoryInstance == null) {
            try {
                Class<? extends Memory> slowMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("com.alipay.sofa.rpc.codec.snappy.SlowMemory").asSubclass(Memory.class);
