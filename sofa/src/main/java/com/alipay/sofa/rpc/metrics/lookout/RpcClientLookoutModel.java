...
public class RpcClientLookoutModel extends RpcAbstractLookoutModel {
    ...
    public String toString() {
        return "RpcClientLookoutModel{" + "targetApp='" + targetApp + '\'' + ", requestSize=" + requestSize + ", responseSize=" + responseSize + ", app='" + app + '\'' + ", service='" + service + '\'' + ", method='" + method + '\'' + ", protocol='" + protocol + '\'' + ", invokeType='" + invokeType + '\'' + ", elapsedTime=" + elapsedTime + ", success=" + success + '}';
    }
