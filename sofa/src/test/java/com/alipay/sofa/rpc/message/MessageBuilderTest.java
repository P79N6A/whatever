...
public class MessageBuilderTest {
    ...
    public void buildSofaRequest() throws Exception {
        SofaRequest request = MessageBuilder.buildSofaRequest(Number.class, "intValue", new Class[0], CodecUtils.EMPTY_OBJECT_ARRAY);
    ...
    public void buildSofaRequest1() throws Exception {
        ...
        SofaRequest request = MessageBuilder.buildSofaRequest(Number.class, method, new Class[0], StringUtils.EMPTY_STRING_ARRAY);
        Assert.assertEquals(request.getInterfaceName(), Number.class.getName());
        Assert.assertEquals(request.getMethodName(), "intValue");
