...
public class LocalRegistryTest {
    ...
    public static void setUp() {
        ...
        registryConfig = new RegistryConfig().setProtocol("local")
                //.setParameter("registry.local.scan.period", "1000")
                .setSubscribe(true).setRegister(true);
    ...
    public void testLoadFile() {
        ...
        RegistryConfig newRegistryConfig = new RegistryConfig().setProtocol("local")
                //.setParameter("registry.local.scan.period", "1000")
                .setSubscribe(true).setFile(file).setRegister(true);
