...
public class AsyncChainTest extends ActivelyDestroyTest {
    ...
    public void testAll() {
        ...
        CProvider.export();
        // B调C的客户端
        ConsumerConfig<HelloService> BConsumer = new ConsumerConfig<HelloService>().setInterfaceId(HelloService.class.getName()).setInvokeType(RpcConstants.INVOKER_TYPE_CALLBACK)
                // .setOnReturn() // 不设置 调用级别设置
                .setTimeout(3000).setDirectUrl("bolt://127.0.0.1:22222");
