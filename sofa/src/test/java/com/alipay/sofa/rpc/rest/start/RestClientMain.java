...
public class RestClientMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ConsumerConfig<RestService> consumerConfig = new ConsumerConfig<RestService>().setApplication(application).setInterfaceId(RestService.class.getName()).setProtocol("rest").setBootstrap("rest").setDirectUrl("rest://127.0.0.1:8888")
                //.setRegister(false)
                .setTimeout(3000);
