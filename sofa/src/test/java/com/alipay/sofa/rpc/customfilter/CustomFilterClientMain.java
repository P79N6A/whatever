...
public class CustomFilterClientMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ConsumerConfig<HelloService> consumerConfig = new ConsumerConfig<HelloService>().setApplication(application).setInterfaceId(HelloService.class.getName()).setDirectUrl("bolt://127.0.0.1:22000").setFilter(Arrays.asList("customEcho")).setFilterRef(Arrays.asList(customEchoFilter2)).setRegister(false).setTimeout(3000);
