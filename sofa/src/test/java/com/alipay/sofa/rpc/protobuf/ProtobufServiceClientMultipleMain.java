...
public class ProtobufServiceClientMultipleMain {
    ...
    public static void main(String[] args) {
        ...
        ConsumerConfig<ProtoService> consumerConfig = new ConsumerConfig<ProtoService>().setInterfaceId(ProtoService.class.getName()) // 指定接口
                .setProtocol("bolt") // 指定协议
                .setApplication(application).setDirectUrl("bolt://127.0.0.1:12200") // 指定直连地址
        ...
        final ThreadPoolExecutor service1 = new ThreadPoolExecutor(threads, threads, 0L, TimeUnit.MILLISECONDS, new SynchronousQueue<Runnable>(), new NamedThreadFactory("client-"));// 无队列
