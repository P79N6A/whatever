...
public class ZookeeperServerRestartTest extends BaseZkTest {
    ...
    public void testAll() throws Exception {
        ...
        final ConsumerConfig<HelloService> consumerConfig = new ConsumerConfig<HelloService>().setInterfaceId(HelloService.class.getName()).setRegistry(registryConfig).setTimeout(3333).setProtocol(RpcConstants.PROTOCOL_TYPE_BOLT).setReconnectPeriod(60000); // avoid reconnect in this test case
