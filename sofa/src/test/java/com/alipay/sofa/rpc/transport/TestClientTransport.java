...
public class TestClientTransport extends ClientTransport {
    ...
    protected TestClientTransport(ClientTransportConfig transportConfig) {
        ...
        channel = new TestChannel(InetSocketAddress.createUnresolved(transportConfig.getProviderInfo().getHost(), transportConfig.getProviderInfo().getPort()), InetSocketAddress.createUnresolved(transportConfig.getProviderInfo().getHost(), new Random().nextInt(65535)));
        available = true;
    }
